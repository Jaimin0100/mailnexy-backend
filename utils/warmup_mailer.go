...
// 	"github.com/yourusername/testingsystem/models"
// 	"gopkg.in/gomail.v2"
// 	"gorm.io/gorm"
// )
...
// func NewWarmupMailer(db *gorm.DB) *WarmupMailer {
// 	return &WarmupMailer{
// 		db: db,
// 		validDomains: []string{
...
// 	toEmail := wm.generateRandomEmail()

// 	// Validate email format before sending
// 	if !wm.isValidEmailFormat(toEmail) {
// 		return fmt.Errorf("invalid email format generated: %s", toEmail)
// 	}
